...
import { Heart, MessageCircle, Share2, Award, Music, Plus, Send, Check, Eye, VolumeX, Volume2, Users, MapPin, Bookmark, TrendingUp, Trash2, Gift, Camera } from 'lucide-react-native';
    ...
    <Pressable 
                  ...
                  <Animated.View key={layer.id} style={{ position: 'absolute', alignSelf: 'center', top: '50%', transform }} pointerEvents={layer.type === 'interactive' ? 'auto' : 'none'}>
                    ...
                    {layer.type === 'interactive' && layer.content && layer.content.type === 'location' && (
                      ...
                      >
                        ...
                        <MapPin size={16} color={layer.content.styleVariant === 0 ? '#7C3AED' : '#FFFFFF'} />
      ...
      >
        ...
        <View className="relative items-center mb-6">
          ...
          >
            {isFollowing ? <Check size={10} color="#fff" strokeWidth={3} /> : <Plus size={10} color="#fff" strokeWidth={3} />}
          </Pressable>
        </View>
