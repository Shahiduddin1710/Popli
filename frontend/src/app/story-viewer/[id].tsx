                ...
                return (
                  ...
                  >
                    ...
                    {layer.type === 'interactive' && layer.content?.type === 'reaction' && (
                      <ReactionSticker layer={layer} onReact={() => handleStickerInteraction(layer.id, 'REACTION', layer.content.emoji || 'heart')} />
                    )}
                  ...
                  onPress={() => {
                    ...
                    router.push({
                      ...
                      params: {
                        ...
                        originalOwnerUsername: activeStory.originalOwnerUsername || activeStory.creatorId,
                        returnTo: 'dismiss3'
                      }
                    });
                  }}
