...
import { ChevronLeft, Sparkles, Bell, Image, Camera, Mic, Check } from 'lucide-react-native';
       ...
       <Pressable
          ...
          >
            ...
            <View className={`w-6 h-6 rounded-full items-center justify-center border ${
              ...
              {permissionsState.notifications && <Check size={10} color="#fff" strokeWidth={3} />}
            </View>
          </Pressable>
          ...
          >
            ...
            <View className={`w-6 h-6 rounded-full items-center justify-center border ${
              permissionsState.media ? 'bg-primary-pink border-primary-pink' : 'border-white/10'
                      ...
                      {permissionsState.media && <Check size={10} color="#fff" strokeWidth={3} />}
            </View>
          </Pressable>
          ...
          >
            ...
            <View className={`w-6 h-6 rounded-full items-center justify-center border ${
              permissionsState.camera ? 'bg-primary-pink border-primary-pink' : 'border-white/10'
                     ...
                     {permissionsState.camera && <Check size={10} color="#fff" strokeWidth={3} />}
            </View>
          </Pressable>
          ...
          >
            ...
            <View className={`w-6 h-6 rounded-full items-center justify-center border ${
              permissionsState.mic ? 'bg-primary-pink border-primary-pink' : 'border-white/10'
                     ...
                     {permissionsState.mic && <Check size={10} color="#fff" strokeWidth={3} />}
            </View>
          </Pressable>
