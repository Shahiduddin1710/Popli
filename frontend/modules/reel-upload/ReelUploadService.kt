package com.shaho.popli.reelupload
...
class ReelUploadService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.shaho.popli.reelupload.START"
        const val ACTION_STOP = "com.shaho.popli.reelupload.STOP"
        const val ACTION_START_STORY = "com.shaho.popli.reelupload.START_STORY"
    }
